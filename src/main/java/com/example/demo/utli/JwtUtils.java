...
public class JwtUtils {
    ...
    public static boolean checkToken(String jwtToken) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new GuliException(ResultCode.ERROR,"token错误或过期");
        }
        return true;
    }
    ...
    public static String getMemberNicknameByJwtToken(HttpServletRequest request) {
        ...
        try {
            Claims claims1 = Jwts.parser().setSigningKey(APP_SECRET).parseClaimsJws(jwtToken).getBody();
